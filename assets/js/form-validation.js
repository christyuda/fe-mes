    ...
    const fv = FormValidation.formValidation(formValidationExamples, {
      fields: {
        formValidationName: {
          validators: {
            ...
            stringLength: {
              min: 6,
              max: 30,
              message: 'Nama Harus Lebih Dari 6 dan Kurang Dari 30 Karakter'
            },
            regexp: {
              regexp: /^[a-zA-Z0-9 ]+$/,
              message: 'Nama Hanya Boleh Mengandung Huruf dan Angka'
            }
          }
        },
        formValidationEmail: {
          validators: {
            notEmpty: {
              message: 'Silahkan Masukkan Alamat Email Anda'
            },
            emailAddress: {
        ...
        formValidationConfirmPass: {
          validators: {
            notEmpty: {
              message: 'Silahkan Masukkan Kata Sandi Lagi'
            },
            identical: {
              compare: function () {
